...
public class AirtelActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView list = (ListView) findViewById(R.id.airtelList);
        String[] sports = getResources().getStringArray(R.array.airtelCode);
        ...
        adapter = new AirtelAdapter(this, myData);
